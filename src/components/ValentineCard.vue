...
export default {
  ...
  data() {
    return {
      ...
      photos: [
        ...
        '/src/assets/img/photo (23).jpg',
        '/src/assets/img/photo (24).jpg',
        '/src/assets/img/photo (25).jpg',
        '/src/assets/img/photo (26).jpg',
        '/src/assets/img/photo (27).jpg',
        '/src/assets/img/photo (28).jpg',
        '/src/assets/img/photo (29).jpg',
        '/src/assets/img/photo (30).jpg',
        '/src/assets/img/photo (31).jpg',
        '/src/assets/img/photo (32).jpg',
        '/src/assets/img/photo (33).jpg',
        '/src/assets/img/photo (34).jpg',
        '/src/assets/img/photo (35).jpg',
        '/src/assets/img/photo (36).jpg',
        '/src/assets/img/photo (37).jpg',
        '/src/assets/img/photo (38).jpg',
        '/src/assets/img/photo (39).jpg',
        '/src/assets/img/photo (40).jpg',
        '/src/assets/img/photo (41).jpg',
        '/src/assets/img/photo (42).jpg',
        '/src/assets/img/photo (43).jpg',
        '/src/assets/img/photo (44).jpg',
        '/src/assets/img/photo (45).jpg',
        '/src/assets/img/photo (46).jpg',
        '/src/assets/img/photo (47).jpg',
        '/src/assets/img/photo (48).jpg',
        '/src/assets/img/photo (49).jpg',
        '/src/assets/img/photo (50).jpg',
        '/src/assets/img/photo (51).jpg',
        '/src/assets/img/photo (52).jpg',
        '/src/assets/img/photo (53).jpg',
        '/src/assets/img/photo (54).jpg',
        '/src/assets/img/photo (55).jpg',
        '/src/assets/img/photo (56).jpg',
        '/src/assets/img/photo (57).jpg',
        '/src/assets/img/photo (58).jpg',
        '/src/assets/img/photo (59).jpg',
        '/src/assets/img/photo (60).jpg',
        '/src/assets/img/photo (61).jpg',
        '/src/assets/img/photo (62).jpg',
        '/src/assets/img/photo (63).jpg',
        '/src/assets/img/photo (64).jpg',
        '/src/assets/img/photo (65).jpg',
        '/src/assets/img/photo (66).jpg',
        '/src/assets/img/photo (67).jpg',
        '/src/assets/img/photo (68).jpg',
        '/src/assets/img/photo (69).jpg',
        '/src/assets/img/photo (70).jpg',
        '/src/assets/img/photo (71).jpg',
        '/src/assets/img/photo (72).jpg',
        '/src/assets/img/photo (73).jpg',
        '/src/assets/img/photo (74).jpg',
        '/src/assets/img/photo (75).jpg',
        '/src/assets/img/photo (76).jpg',
        '/src/assets/img/photo (77).jpg',
        '/src/assets/img/photo (78).jpg',
        '/src/assets/img/photo (79).jpg',
        '/src/assets/img/photo (80).jpg',
        '/src/assets/img/photo (81).jpg',
        '/src/assets/img/photo (82).jpg',
        '/src/assets/img/photo (83).jpg',
        '/src/assets/img/photo (84).jpg',
        '/src/assets/img/photo (85).jpg',
        '/src/assets/img/photo (86).jpg',
        '/src/assets/img/photo (87).jpg',
        '/src/assets/img/photo (88).jpg',
        '/src/assets/img/photo (89).jpg',
        '/src/assets/img/photo (90).jpg',
        '/src/assets/img/photo (91).jpg',
        '/src/assets/img/photo (92).jpg',
        '/src/assets/img/photo (93).jpg',
        '/src/assets/img/photo (94).jpg',
        '/src/assets/img/photo (95).jpg',
        '/src/assets/img/photo (96).jpg',
        '/src/assets/img/photo (97).jpg',
        '/src/assets/img/photo (98).jpg',
        '/src/assets/img/photo (99).jpg',
        '/src/assets/img/photo (100).jpg',
        '/src/assets/img/photo (101).jpg',
        '/src/assets/img/photo (102).jpg',
        '/src/assets/img/photo (103).jpg',
        '/src/assets/img/photo (104).jpg',
        '/src/assets/img/photo (105).jpg',
        '/src/assets/img/photo (106).jpg',
        '/src/assets/img/photo (107).jpg',
        '/src/assets/img/photo (108).jpg',
        '/src/assets/img/photo (109).jpg',
        '/src/assets/img/photo (110).jpg',
        '/src/assets/img/photo (111).jpg',
        '/src/assets/img/photo (112).jpg'
      ],
    }
  },
  computed: {
  ...
  methods: {
    ...
    initBackgroundMusic() {
      ...
      this.backgroundMusic.src = '/src/assets/music/beautiful-in-white.mp3'
